    ...
    <div className="space-y-4">
      <Card className="bg-card border-border">
        <CardHeader className="pb-2">
          <CardTitle className="text-cyan-400">
            What is Teddy Betting?
          </CardTitle>
          <CardDescription>Understanding the game mechanics</CardDescription>
        </CardHeader>
        <CardContent className="text-sm space-y-3">
          <p className="text-muted-foreground">
            Teddy betting is a game where players bet Teddy (Twitch's currency)
            on the outcome of Master Duel gacha pulls. Mr. Mo pulls cards from 1
            to 40 packs (each pack contains 8 cards), and winners are determined
            based on which "car" correctly predicts the result.
          </p>
          ...
          <div>
            ...
            <ul className="text-muted-foreground space-y-1 list-disc list-inside">
              <li>
                <span className="text-foreground">UR Cars:</span> Specify a
                range of UR cards that must be pulled
              </li>
              <li>
                <span className="text-foreground">Royal Car:</span> Wins if a
                Royal UR card is pulled (higher priority)
              </li>
            </ul>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="bg-secondary p-3 rounded-lg text-sm">
            ...
            <ul className="text-muted-foreground space-y-1">
              <li>
                <span className="text-foreground">10-pack:</span> 9 regular + 1
                SR pack
              </li>
              <li>
                <span className="text-foreground">UR 10-pack:</span> 9 regular +
                1 UR pack (pity)
              </li>
              <li>
                <span className="text-foreground">Royal:</span> 1% chance on any
                card
              </li>
            </ul>
          </div>
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="text-sm space-y-2">
          <p className="text-muted-foreground">
            The reward ratio is determined by how much Teddy is bet on each car:
          </p>
          <div className="bg-secondary p-3 rounded-lg font-mono text-center text-primary">
            Return = Teddy_total / Teddy_winning_car
          </div>
          <p className="text-muted-foreground">
            Example: If 50% is bet on the winning car, winners get 2x return.
          </p>
        </CardContent>
      </Card>
    </div>
